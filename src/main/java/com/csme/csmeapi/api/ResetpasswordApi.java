...
public interface ResetpasswordApi {
    ...
    @ApiOperation(value = "resetpassword", nickname = "resetpassword", notes = "", response = XResetPasswordResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "Reset Password", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = XResetPasswordResponse.class),
    ...
    ResponseEntity<XResetPasswordResponse> resetpassword(@ApiParam(value = "Reset Password" ,required=true )  @Valid @RequestBody XResetPasswordRequest body
