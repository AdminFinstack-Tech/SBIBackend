...
@Api(value = "InquireAuthUserList", description = "the InquireAuthUserList API")
public interface InquireAuthUserListApi {

    Logger log = LoggerFactory.getLogger(InquireAuthUserListApi.class);
    ...
    @ApiOperation(value = "Inquire Auth List", nickname = "inquireAuthList", notes = "", response = XAuthUserListResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "InquireAuthUserList", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = XAuthUserListResponse.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/InquireAuthUserList",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<XAuthUserListResponse> inquireAuthList(@ApiParam(value = "Inquire Auth User List" ,required=true )  @Valid @RequestBody XAuthUserListRequest body
