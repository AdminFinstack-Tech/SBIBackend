...
@Api(value = "forgotcredential", description = "the forgotcredential API")
public interface ForgotcredentialApi {

    Logger log = LoggerFactory.getLogger(ForgotcredentialApi.class);
    ...
    @ApiOperation(value = "Forgot Credentail", nickname = "forgotcredential", notes = "", response = XForgotCredentialResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "forgotcredential", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = XForgotCredentialResponse.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/forgotcredential",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<XForgotCredentialResponse> forgotcredential(@ApiParam(value = "Forgot Password" ,required=true )  @Valid @RequestBody XForgotCredentialRequest body
