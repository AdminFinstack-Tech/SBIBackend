...
public interface ProfileApi {
    ...
    Logger log = LoggerFactory.getLogger(ProfileApi.class);
    ...
    @ApiOperation(value = "Profile Information", nickname = "profile", notes = "", response = ProfileResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "Profile", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Profile Information Response", response = ProfileResponse.class),
    ...
    ResponseEntity<ProfileResponse> profile(@ApiParam(value = "Profile Inforamation Request" ,required=true )  @Valid @RequestBody ProfileRequest body
