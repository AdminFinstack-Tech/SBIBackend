...
public interface NotificationApi {
    ...
    @ApiOperation(value = "Send Notification", nickname = "sendNotification", notes = "", response = XNotificationResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "Notification", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = XNotificationResponse.class),
    ...
    ResponseEntity<XNotificationResponse> sendNotification(@ApiParam(value = "Notification Request" ,required=true )  @Valid @RequestBody XNotificationRequest body
