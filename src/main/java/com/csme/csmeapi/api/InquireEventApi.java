...
@Api(value = "InquireEvent", description = "the InquireEvent API")
public interface InquireEventApi {

    Logger log = LoggerFactory.getLogger(InquireEventApi.class);
    ...
    @ApiOperation(value = "Inquire Event History", nickname = "inquireEvent", notes = "", response = XInquireEventResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "InquireEvent", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = XInquireEventResponse.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/InquireEvent",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<XInquireEventResponse> inquireEvent(@ApiParam(value = "Inquire Event History of Transaction" ,required=true )  @Valid @RequestBody XInquireEventRequest body
