...
public interface AuthorizeApi {
    ...
    Logger log = LoggerFactory.getLogger(AuthorizeApi.class);
    ...
    @ApiOperation(value = "Authorize Transaction", nickname = "authorizeTransaction", notes = "", response = XAuthorizeResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "Authorize", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = XAuthorizeResponse.class),
    ...
    ResponseEntity<XAuthorizeResponse> authorizeTransaction(@ApiParam(value = "Request Id" ,required=true) @RequestHeader(value="requestId", required=true) UUID requestId
