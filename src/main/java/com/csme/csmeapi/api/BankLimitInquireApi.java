...
@Api(value = "BankLimitInquire", description = "the BankLimitInquire API")
public interface BankLimitInquireApi {

    Logger log = LoggerFactory.getLogger(BankLimitInquireApi.class);
    ...
    @ApiOperation(value = "Bank Limit Inquire", nickname = "bankLimitInquire", notes = "", response = XBankLimitInquireResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "BankLimitInquire", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = XBankLimitInquireResponse.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/BankLimitInquire",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<XBankLimitInquireResponse> bankLimitInquire(@ApiParam(value = "Inquire Event History of Transaction" ,required=true )  @Valid @RequestBody XBankLimitInquireRequest body
