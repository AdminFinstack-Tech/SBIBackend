...
public interface LoginApi {
    ...
    @ApiOperation(value = "Login", nickname = "login", notes = "", response = LoginResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "Login", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<LoginResponse> login(@ApiParam(value = "Login Request" ,required=true )  @Valid @RequestBody LoginRequest body
