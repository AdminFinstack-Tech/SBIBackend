...
public class ModuleAnalyticsApiService {
    ...
    public XModuleAnalyticsResponse getModuleAnalytics(XModuleAnalyticsRequest request, String requestId) 
        ...
        try {
            ...
            String beneficiariesQuery = getQueryFromXML(xmlDoc, "getTopBeneficiariesByModule");
    ...
    private String buildParameterizedQuery(String query, String corporateId, String module, int months) {
        // Simple parameter replacement for this implementation
        // Replace parameters in order: corporateId, module, months
        String result = query;
        result = result.replaceFirst("\\?", "'" + corporateId + "'");
        result = result.replaceFirst("\\?", "'" + module + "'");
        result = result.replaceFirst("\\?", String.valueOf(-months));
        return result;
    }
    
    private String getBaseCurrency(String corporateId) {
        try {
            String currency = MobileConfig.getProperty("BASE_CURRENCY");
