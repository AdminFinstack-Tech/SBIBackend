...
@Api(value = "InquireList", description = "the InquireList API")
public interface InquireListApi {

    Logger log = LoggerFactory.getLogger(InquireListApi.class);
    ...
    @ApiOperation(value = "Inquire List", nickname = "inquireList", notes = "", response = XInquiryListResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "Inquire List", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<XInquiryListResponse> inquireList(@ApiParam(value = "Login Request" ,required=true )  @Valid @RequestBody XInquiryListRequest body
