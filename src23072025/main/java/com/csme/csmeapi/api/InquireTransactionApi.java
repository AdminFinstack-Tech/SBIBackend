...
@Api(value = "InquireTransaction", description = "the InquireTransaction API")
public interface InquireTransactionApi {

    Logger log = LoggerFactory.getLogger(InquireTransactionApi.class);
    ...
    @ApiOperation(value = "InquireTransaction", nickname = "inquireTransaction", notes = "", response = XInquireTransactionResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "InquireTransaction", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = XInquireTransactionResponse.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/InquireTransaction",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<XInquireTransactionResponse> inquireTransaction(@ApiParam(value = "Inquire based on Transaction" ,required=true )  @Valid @RequestBody XInquireTransactionRequest body
