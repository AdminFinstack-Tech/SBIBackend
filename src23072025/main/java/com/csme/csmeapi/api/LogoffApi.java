...
@Api(value = "Logoff", description = "the Logoff API")
public interface LogoffApi {

    Logger log = LoggerFactory.getLogger(LogoffApi.class);
    ...
    @ApiOperation(value = "Logoff", nickname = "logoff", notes = "", response = LogoffResponse.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "Logoff", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = LogoffResponse.class),
    ...
    ResponseEntity<LogoffResponse> logoff(@ApiParam(value = "Login Request" ,required=true )  @Valid @RequestBody LogoffRequest body
