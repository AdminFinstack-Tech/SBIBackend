...
@Api(value = "SaveFBToken", description = "the SaveFBToken API")
public interface SaveFBTokenApi {

    Logger log = LoggerFactory.getLogger(SaveFBTokenApi.class);
    ...
    @ApiOperation(value = "SaveFBToken", nickname = "saveFBToken", notes = "", response = SaveFBTokenResponsePost.class, authorizations = {
        @Authorization(value = "jwt")    }, tags={ "SaveFBToken", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = SaveFBTokenResponsePost.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/SaveFBToken",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<SaveFBTokenResponsePost> saveFBToken(@ApiParam(value = "FB Token Request" ,required=true )  @Valid @RequestBody SaveFBTokenRequestPost body
